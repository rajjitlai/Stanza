                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="glass-card p-8 md:p-12 mb-12 relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
                            <div className="w-24 h-24 md:w-32 md:h-32 rounded-3xl bg-gradient-to-br from-accent to-accent-light flex items-center justify-center text-darker-bg font-serif text-4xl md:text-5xl font-bold shadow-accent-glow">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-text-secondary text-lg italic max-w-2xl">
                                ...
                                <div className="mt-6 flex items-center justify-center md:justify-start gap-6 text-sm">
                                    <div className="text-text-muted">
                                        <span className="text-accent font-bold text-lg mr-2">{poems.length}</span>
                                        Stanzas written
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        <h2 className="text-2xl font-serif font-bold text-text-primary">Published Works</h2>
